      ...
      <div class='flex flex-col gap-4 place-items-center place-content-center sm:flex-row p-8 text-center rounded-lg sm:p-8 bg-green-light sm:w-5/6 sm:h-32 w-5/6 '>
        ...
        <div v-if="showDiv" class="flex flex-col text-left">
          ...
          <div class="flex">
            ...
            <select  v-model="jurosTipo" @change="updateInputs"  class="lg:w-16 sm:w-14 text-xs p-1 rounded-r-md border-b-4 border-l-2 text-gray-400 bg-input border-gray-300 focus:border-b-brand-green">
        ...
        <div v-if="showDiv" class="flex flex-col text-left">
          ...
          <div class="flex">
            ...
            <select v-model="tempoTipo" @change="updateInputs" class="w-16 lg:w-16 sm:w-14 text-xs p-1 rounded-r-md border-b-4 border-l-2 text-gray-400 bg-input border-gray-300 focus:border-b-brand-green">
                <option value="anual">Anual</option>
                <option value="mensal">Mensal</option>
            </select>
          </div>
