...
export default {
  setup() {
    ...
    const links = computed(() => [
      ...
      { to: '/RentabilidadeReal', i18nKey: 'navbar.rentabilidadeReal' },
      { to: '/CustoOportunidade', i18nKey: 'navbar.custoOportunidade' },
      { to: '/PlanejadorAposentadoria', i18nKey: 'navbar.planejadorAposentadoria' },
      { to: '/ConversorTaxasJuros', i18nKey: 'navbar.conversorTaxasJuros' },
      { to: '/VPL', i18nKey: 'navbar.vpl' },
      { to: '/TIR', i18nKey: 'navbar.tir' },
      { to: '/Payback', i18nKey: 'navbar.payback' },
      { to: '/CET', i18nKey: 'navbar.cet' },
      { to: '/AluguelVsCompra', i18nKey: 'navbar.aluguelVsCompra' },
      { to: '/PontoEquilibrio', i18nKey: 'navbar.pontoEquilibrio' },
    ]);
