...
export default {
  ...
  methods: {
    calcular() {
      ...
      const ValorInicialSimples = valorFinal / ((jurosAnual / 100) * (tempoAnual) + 1);

      this.step01 = `Vi = ${valorFinal} / (1 + ${jurosAnual/100} * ${tempoAnual})`;
      this.step02 = `Vi = ${valorFinal} / ${1 + (jurosAnual/100) * tempoAnual}`;
